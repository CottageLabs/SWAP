...
$.getScript("/static/holder/topojson.v1.min.js");
...
$.fn.holder.display.scotland = function(obj) {
  ...
  var scotland = function(target,locations) {
    ...
    d3.json("/static/holder/all_councils_topo.json", function(error, scotland) {
  ...
  if (!options.paging) {
    ...
    if ( JSON.stringify(oc) === '{}' ) {
      $.getScript("/static/holder/outcodes.js", function() {
